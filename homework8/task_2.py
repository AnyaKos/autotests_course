...
class Trigon():
    """Работа со сторонами треугольника"""
    def __init__(self, *args):
        """
        Инициализация класса и проверка на корректность переданных данных
        :param args: Длины трех сторон треугольника
        """
        if len(args) != 3:
        ...
        try:
            ...
            if self.a + self.b <= self.c or self.a + self.c <= self.b or self.b + self.c <= self.a:
                raise Exception(f'Не треугольник')
        except TypeError:
