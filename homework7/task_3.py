...
class PublicTransport:
    ...
    def info(self):
        ...
        :return: Строка с информацией о транспорте: марке, цвете, годе выпуска и мощности двигателя
        """
        return f'Марка: {self.brand}\nЦвет: {self.color}\nГод выпуска: {self.year}\nМощность двигателя: {self._engine_power}\n'


class Bus(PublicTransport):
    """Класс Bus унаследован от PublicTransport"""
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, passengers: int, park: int, fare: int):
        """
        Инициализация унаследованного класса Bus
        :param brand: Марка транспорта
        :param engine_power: Мощность двигателя
        :param year: Год выпуска
        :param color: Цвет
    ...
    def park(self):
        """
        Добавляет свойство park, которое будет возвращать значение park
    ...
    def park(self, number):
        ...
        :param number: Номер парка
        :return: Присвоенное значение номера парка
        """
